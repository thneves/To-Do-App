...
document.getElementById('todoForm').addEventListener('submit', (e) => {
  ...
  projectArr.forEach((project) => {
    if (project.name === e.target.parentElement.parentElement.firstChild
...
document.getElementById('todoCont').addEventListener('click', (e) => {
  if (e.target.classList.contains('details-btn')) {
    UI.seeDetails(e.target.parentElement.previousElementSibling.previousElementSibling
      .previousElementSibling.previousElementSibling.textContent, projectArr);
  }
});
